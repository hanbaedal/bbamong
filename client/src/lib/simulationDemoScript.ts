...
export const DEMO_SCENES: DemoScene[] = [
  ...
  },
  {
    id: "ui-ad",
    stepId: "screen",
      caption: "공수교대·투수교체 때 리워드 동영상 광고가 나올 수 있습니다. 앱은 끝까지 시청해야 보상 대상이며, 운영자가 광고를 중지하거나 약 80초 후 500P가 지급됩니다. 5초 뒤 왼쪽 위 ×로 끌 수 있으나 그때는 보상이 없습니다. 다음 예측은 운영자가 「예측 시작」을 눌러야 합니다. (배너 광고 없음)",
    durationMs: 8000,
    state: s({
      view: "game-ui",
      matchStatus: "live",
