...
const SECTIONS: { title: string; items: string[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      "오른쪽: 인사말과 메뉴 — 「야구 예측 게임이란?」(게임 소개), 「사용 설명서」(이 페이지), 「게임 시뮬레이션」(연습), 「빠몽이 기념품」(쇼핑) 등",
      "홈 화면에는 하단 메뉴(초대·출석 등)가 없습니다. 예측·게시판 등 다른 화면으로 이동하면 하단 메뉴가 나타납니다.",
    ],
  },
  {
    title: "예측 게임 (타석)",
    items: [
      "홈 왼쪽의 빠몽이 또는 참여 버튼을 눌러 예측 화면에 들어갑니다.",
  ...
  },
  {
    title: "하단 메뉴",
    items: [
      "예측·게시판·설정 등 홈이 아닌 화면 하단에 표시됩니다.",
      "초대: 친구 초대 코드·초대 현황",
      "출석: 출석 체크 및 출석 보상",
      "게시: 회원 게시판 글 읽기·쓰기",
      "추가: 포인트 충전/참여 기회 관련 화면",
      "로그아웃: 계정에서 로그아웃 (다음에 앱을 새로 열면 로그인 화면)",
    ],
  },
  {
    title: "헤더·기타",
