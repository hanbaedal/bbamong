...
const SECTIONS: { title: string; items: string[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      "오른쪽: 인사말과 메뉴 — 「야구 예측 게임이란?」, 「사용설명서」, 「공지사항」, 「문의하기」, 「게시판」, 「빠몽이 선물상자」 등",
  ...
  },
  {
    ...
    items: [
      ...
      `광고가 시작된 뒤 약 ${AD_EARLY_DISMISS_SECONDS}초가 지나면 「×」로 끌 수 있습니다. 끄면 보상은 없습니다.`,
      `끝까지 시청하면 ${AD_REWARD_POINTS}P가 지급됩니다.`,
      "운영자가 「예측 시작」을 누르면 진행 중이던 광고는 중지되며, 이 경우에도 보상은 없습니다.",
    ],
  },
  {
    title: "예측 화면 메뉴",
    items: [
      "왼쪽 세로 메뉴: 「홈」, 「내이야기」, 「기념품」, 「내정보」",
      "내이야기: 승리현황, 친구 초대, 출석 체크, 나의 콘텐츠, 사회공헌 참여현황",
      "내정보: 회원정보, 추가 참여, Q&A, 서비스 이용약관, 탈퇴하기",
      "「기념품」: 빠몽이 선물상자(쇼핑)로 이동합니다.",
    ],
  },
  {
    title: "헤더·기타",
  ...
  },
  {
    ...
    items: [
      ...
      "「게임 시뮬레이션」에서 오늘 경기 목록·사이드 배팅·타석·정산 흐름을 연습하세요.",
