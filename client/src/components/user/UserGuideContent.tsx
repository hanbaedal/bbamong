...
const SECTIONS: { title: string; items: string[] }[] = [
  {
    ...
    items: [
      ...
      "세션이 없으면 환영 인트로(빠몽이 타격 약 4.3초, 「실시간~ 야구 예측게임! 빠던나인!」) 후 로그인 화면이 나옵니다. 로그인 화면 왼쪽에 이용 안내(15세·재화)가 표시됩니다.",
  ...
  },
  {
    ...
    items: [
      ...
      "앱: 광고 화면에 남은 초가 보이고, 40초가 끝나면 예측이 자동으로 시작됩니다. 웹: 약 5초 후 「×」로 끌 수 있으나 보상은 없습니다.",
