...
/** 예측 성공 시 배트 토스+화면 확대 연출 시간(ms) — 주루 시작 전 */
export const SUCCESS_BAT_TOSS_MS = 2000;

/** @deprecated SUCCESS_BAT_TOSS_MS 사용 */
export const HOME_RUN_BAT_TOSS_MS = SUCCESS_BAT_TOSS_MS;
