      ...
      {phase === "wait_start" && (
        ...
        >
          <img
            src={pyamongWaiting}
            alt=""
            className="w-[min(28vw,200px)] h-auto game-sprite-cutout animate-pyamong-idle"
            style={{ transform: "translate(-50%, -50%)" }}
            data-testid="char-pyamong-waiting"
          />
          <p
            className="absolute left-1/2 -translate-x-1/2 top-full mt-2 whitespace-nowrap text-white text-sm sm:text-base font-semibold drop-shadow-lg text-center"
      ...
      {phase === "wait_result" && (
        ...
        >
          <img
            src={batterWaiting}
            alt=""
            className="w-[min(16vw,110px)] h-auto game-sprite-cutout"
      ...
      {phase === "success_running" && (
        ...
        >
          <img
            src={batterWaiting}
            alt=""
            className="w-[min(14vw,96px)] h-auto game-sprite-cutout animate-batter-run"
            style={{ transform: "translate(-50%, -100%)" }}
          />
        </div>
      )}
      ...
      {phase === "success_celebrate" && (
        ...
        >
          <img
            src={pyamongSuccess}
            alt=""
            className="w-[min(30vw,220px)] h-auto game-sprite-cutout animate-pyamong-success"
            style={{ transform: "translate(-50%, -50%)" }}
      ...
      {phase === "fail" && (
        ...
        >
          <img
            src={batterWaiting}
            alt=""
            className="w-[min(16vw,110px)] h-auto game-sprite-cutout opacity-80"
            style={{ transform: "translate(-50%, -100%)" }}
