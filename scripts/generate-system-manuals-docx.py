...
def write_operator() -> Path:
    ...
    add_section(
        ...
        [
            ...
            "처음부터 있는 것이 원칙입니다. 중간 입장도 되며, 지나간 타석은 다시 안 돌리고 화면에 켜진 다음 버튼만 누릅니다.",
            "네트워크가 끊기면 재로그인하지 말고 같은 화면에서 재연결합니다. 같은 기기 재로그인은 허용, 다른 기기는 거부입니다.",
    ...
    add_section(
        ...
        [
            ...
            "중간 합류: 현재 타석부터. 화면에 켜진 다음 버튼만 누릅니다. 지나간 타석은 메우지 않습니다.",
